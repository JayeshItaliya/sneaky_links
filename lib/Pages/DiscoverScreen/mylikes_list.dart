...
class MyLikesList extends StatefulWidget {
  // String search;
  // ULikesList(this.search);

  @override
  State<MyLikesList> createState() => _ULikesListState();
}

class _ULikesListState extends State<MyLikesList> {
  final myController = Get.put(MyLikesController());
